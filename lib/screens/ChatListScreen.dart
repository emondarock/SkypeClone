  ...
  void initState() {
    ...
    _repository.getCurrentUser().then((user) {
      setState(() {
        ...
        intials = Utils.getIntials(user.displayName);
      });
    });
  }
                ...
                children: <Widget>[
                  CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                        "https://lh3.googleusercontent.com/-AkpFuNuSb88/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclJe8JXV7hBgh2VHj7eSIuTdiabrw/s96-c/photo.jpg"
                    ),
                  ),
