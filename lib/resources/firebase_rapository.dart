...
class FirebaseRepository{
  ...
  Future<bool> authenticateUser(AuthResult user) => firebaseMethod.authenticateUser(user);
  Future<void> addDataToDb(FirebaseUser user) => firebaseMethod.addDataToDb(user);
